...
var $author$project$Block$Msg = function (a) {
	return {$: 'Msg', a: a};
};
	...
	return $author$project$Block$Context(
		{
			...
			envelop: function (submsg) {
				return envelope(
					$author$project$Block$Msg(submsg));
			}
		});
};
...
var $author$project$Block$subscriptions = function (_v0) {
	var ctx = _v0.a;
	return A2(
...
var $author$project$MathEx$minmax = F3(
	function (minVal, maxVal, val) {
		return A2(
			$elm$core$Basics$max,
			minVal,
			A2($elm$core$Basics$min, val, maxVal));
	});
...
var $author$project$Delta$Delta = F2(
	function (dx, dy) {
		return {dx: dx, dy: dy};
	});
...
var $author$project$Block$Internal$Component$Offset$rootPos = function (vm) {
		...
		return $author$project$DragState$init(
			{
				...
				data: bd,
				start: $author$project$Block$Internal$Component$Offset$rootPos(vm)
			});
	});
...
var $author$project$Block$Internal$Component$Width$circlePos = F2(
	function (vm, root) {
		return A2(
			...
			A2($author$project$Delta$Delta, vm.grid.unit, vm.block.size.height / 2),
			root);
	});
...
var $author$project$Block$Internal$Config$barLineWidth = 3;
var $elm$svg$Svg$circle = $elm$svg$Svg$trustedNode('circle');
var $author$project$Block$Internal$Config$circleActiveSize = function (unit) {
	return unit / 1.2;
};
var $author$project$Block$Internal$Config$circleIdleSize = function (unit) {
	return unit / 1.5;
};
var $author$project$Block$Internal$Config$connectorLineWidth = 3;
...
var $author$project$Block$Internal$Component$Offset$viewControl = F2(
	function (attrs, vm) {
		var _v0 = function () {
			...
			if ((_v1.$ === 'Dragging') && (_v1.a.$ === 'Offset')) {
				var _v2 = _v1.a;
				var drag = _v1.b;
				return _Utils_Tuple2(
					$author$project$Block$Internal$Config$circleActiveSize(vm.grid.unit),
					drag.pos.total);
			} else {
				return _Utils_Tuple2(
					$author$project$Block$Internal$Config$circleIdleSize(vm.grid.unit),
					$author$project$Block$Internal$Component$Offset$rootPos(vm));
			}
		}();
		var radius = _v0.a;
		var pos = _v0.b;
		...
		var barP2 = A2(
			$author$project$Pos$addDelta,
			A2($author$project$Delta$Delta, 0, vm.grid.unit),
			pos);
		var connectorP1 = A2(
			$author$project$Pos$addDelta,
			A2($author$project$Delta$Delta, -vm.grid.unit, vm.grid.unit / 2),
			pos);
		var circlePos = connectorP1;
		var connectorP2 = A2(
			$author$project$Pos$addDelta,
			A2($author$project$Delta$Delta, vm.grid.unit, 0),
			connectorP1);
		return A2(
			$elm$svg$Svg$g,
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$x1(
							$author$project$Pos$toXString(barP1)),
							$elm$svg$Svg$Attributes$y1(
							$author$project$Pos$toYString(barP1)),
							$elm$svg$Svg$Attributes$x2(
							$author$project$Pos$toXString(barP2)),
							$elm$svg$Svg$Attributes$y2(
							$author$project$Pos$toYString(barP2)),
							$elm$svg$Svg$Attributes$strokeWidth(
							$elm$core$String$fromFloat($author$project$Block$Internal$Config$barLineWidth))
						]),
					_List_Nil),
					A2(
					$elm$svg$Svg$line,
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$x1(
							$author$project$Pos$toXString(connectorP1)),
							$elm$svg$Svg$Attributes$y1(
							$author$project$Pos$toYString(connectorP1)),
							$elm$svg$Svg$Attributes$x2(
							$author$project$Pos$toXString(connectorP2)),
							$elm$svg$Svg$Attributes$y2(
							$author$project$Pos$toYString(connectorP2)),
							$elm$svg$Svg$Attributes$strokeWidth(
							$elm$core$String$fromFloat($author$project$Block$Internal$Config$connectorLineWidth))
						]),
					_List_Nil),
					A2(
					$elm$svg$Svg$circle,
					_List_fromArray(
						[
							...
							$author$project$Pos$toXString(circlePos)),
							$elm$svg$Svg$Attributes$cy(
							$author$project$Pos$toYString(circlePos)),
...
var $author$project$Block$Internal$Component$Quantity$viewControl = F2(
	function (attrs, vm) {
		...
		var lineWidth = 3;
		var rectSize = $author$project$Size$init(
			_Utils_Tuple2(unit + (2 * lineWidth), unit + (2 * lineWidth)));
		var halfUnit = unit / 2;
		var _v0 = function () {
			var _v1 = vm.block.state;
			if ((_v1.$ === 'Dragging') && (_v1.a.$ === 'Quantity')) {
				...
				var drag = _v1.b;
				return _Utils_Tuple2(
					$elm$core$Basics$round(vm.grid.unit / 1.2),
					drag.pos.total);
			} else {
				return _Utils_Tuple2(
					$elm$core$Basics$round(vm.grid.unit / 1.5),
					$author$project$Block$Internal$Component$Quantity$rootPos(vm));
			}
		}();
		var radius = _v0.a;
		var pos = _v0.b;
		var rectPos = function () {
			var delta = $author$project$Delta$init(
				_Utils_Tuple2(-lineWidth, -lineWidth));
			return A2($author$project$Pos$addDelta, delta, pos);
		}();
		var vlineP1 = A2(
			$author$project$Pos$add,
			rectPos,
			$author$project$Pos$init(
				_Utils_Tuple2(halfUnit + lineWidth, rectSize.height)));
		var vlineP2 = A2(
			$author$project$Pos$addY,
			vlineP1,
			$author$project$Pos$init(
				_Utils_Tuple2(0, unit)));
		var circlePos = vlineP2;
		return A2(
			$elm$svg$Svg$g,
			A2(
				$elm$core$List$cons,
				$elm$svg$Svg$Attributes$class('quantity-control'),
				attrs),
			_List_fromArray(
				[
					A2(
...
var $author$project$Block$Internal$Component$Quantity$view = F2(
	function (attrs, vm) {
		var _v0 = vm.block.state;
		_v0$2:
		while (true) {
...
var $author$project$Block$Internal$Component$Width$guideLineWidth = 3;
...
var $author$project$Block$Internal$Component$Width$viewControl = F2(
	function (attrs, vm) {
		var _v0 = function () {
			...
			if ((_v1.$ === 'Dragging') && (_v1.a.$ === 'Width')) {
				...
				return {
					...
					guideVisible: true,
					radius: $elm$core$Basics$round(vm.grid.unit / 1.2),
				...
				return {
					...
					guideVisible: false,
					radius: $elm$core$Basics$round(vm.grid.unit / 1.5),
					rootpos: root
				};
			}
		}();
		...
		var cpos = _v0.cpos;
		var guideVisible = _v0.guideVisible;
		var vbarP1 = rootpos;
		var hbarP1 = A2(
			$author$project$Pos$addDelta,
			$author$project$Delta$init(
		...
		var vbarP2 = A2(
			...
			vbarP1);
		var _v3 = guideVisible ? _Utils_Tuple2(
				...
				[
					...
					_List_fromArray(
						[
							...
							$elm$svg$Svg$Attributes$strokeWidth(
							$elm$core$String$fromFloat($author$project$Block$Internal$Component$Width$guideLineWidth)),
					...
					_List_fromArray(
						[
							$elm$svg$Svg$Attributes$cx(
							$author$project$Pos$toXString(cpos)),
							$elm$svg$Svg$Attributes$cy(
							$author$project$Pos$toYString(cpos)),
							$elm$svg$Svg$Attributes$r(
							$elm$core$String$fromInt(radius))
						]),
					_List_Nil)
		...
		var controls = $elm_community$maybe_extra$Maybe$Extra$values(
			_List_fromArray(
				[
					...
					eventAttrsFn($author$project$Block$Internal$Component$Offset),
					vm),
					A2(
